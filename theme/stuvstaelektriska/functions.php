<?php
/**
 * Stuvsta Elektriska AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Stuvsta Elektriska AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'stuvstaelektriska', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'stuvstaelektriska' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'stuvstaelektriska' ) ) );

		register_block_pattern_category( 'stuvstaelektriska-sections', array( 'label' => __( 'Stuvsta Elektriska AB sections', 'stuvstaelektriska' ) ) );
		register_block_pattern_category( 'stuvstaelektriska-pages', array( 'label' => __( 'Stuvsta Elektriska AB page layouts', 'stuvstaelektriska' ) ) );
	}
);
